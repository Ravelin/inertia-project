...
var render = function() {
  ...
  return _c("layout", [
    _c("div", [
      ...
      _vm._v(" "),
      _c("table", { staticClass: "table table-responsive-lg table-striped" }, [
        _c("thead", [
          _c("th", [_vm._v("Name")]),
          _vm._v(" "),
          _c("th", [_vm._v("Email")]),
...
var render = function() {
  ...
  var _c = _vm._self._c || _h
  return _c("main", [
    _c("nav", { staticClass: "nav navbar-expand-lg bg-red container" }, [
      _vm._m(0),
      _vm._v(" "),
      _c(
        "div",
        {
          ...
          attrs: { id: "navbarMarkup" }
        },
        [
          _c(
            "div",
            { staticClass: "navbar navbar-nav" },
            [
              _c(
                "inertia-link",
...
/* harmony import */ var _Layout_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Layout.vue?vue&type=style&index=0&lang=css& */ "./resources/js/Shared/Layout.vue?vue&type=style&index=0&lang=css&");
